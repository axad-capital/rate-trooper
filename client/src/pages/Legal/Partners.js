    ...
    <div>
      ...
      <div className='legal partners'>
        ...
        <ul>
          ...
          <li>Excel Impact</li>
          <li>EasyHealth Insurance Services<br />
            Medicare10</li>
          ...
          <li>LizDev, Inc</li>
          <li>Medicare Concepts, LLC</li>
          <li>Medicare Discount Card</li>
          <li>Medicare Plus Card</li>
          <li>Medicare Rewards</li>
          <li>Narrate LLC</li>
          <li>OpenJar Concepts</li>
          <li>Otis Production LLC</li>
          <li>Palo Media Group</li>
